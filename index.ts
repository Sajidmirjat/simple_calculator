...
const answer = await inquirer.prompt([
  ...
  },
  {
    ...
    type: "list",
    message:
      "Select one of the operator from listed below to perform operation.",
    choices: [
      "Addition",
      "Subtraction",
      "Multiplication",
...
if (answer.operator === "Exponentiation") {
  console.log(
    "Exponent of two numbers is: ",
    answer.firstNumber ** answer.secondNumber
  );
}
if (answer.operator === "Multiplication") {
  console.log(
    "Value after multiplying : ",
    answer.firstNumber * answer.secondNumber
  );
}
...
if (
  answer.operator === "Percentage" && answer.firstNumber <= answer.secondNumber
) {
  console.log(
    "Percentage of two numbers is: ",
  ...
  console.log(
    "You entered an invalid number, please check and re enter a valid number."
  )
}
